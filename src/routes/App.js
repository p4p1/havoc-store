...
function Module() {
  return(
    <div className="module-container">
      <img className="module-preview" src="https://raw.githubusercontent.com/p4p1/havoc-reporter/main/assets/reporter.png" alt="something"/>
      <div className="module-title">
        <p>havoc-reporter</p>
        <p>p4p1</p>
        <a className="header-link" href="https://github.com/p4p1/havoc-reporter">Download</a>
      </div>
      <p>A havoc UI python module to help in reporting and vulnerabilities to exploit on an internal network.</p>
    </div>
  );
}
